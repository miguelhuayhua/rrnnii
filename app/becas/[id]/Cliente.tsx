...
import { Beca, ParticipanteBeca, Institucion } from "@prisma/client";
...
interface Props {
    value: Beca & { Participantes: ParticipanteBeca[], Institucion: Institucion };
}
...
export default function Cliente({ value }: Props) {
    ...
    useEffect(() => {
        axios.post('/api/beca/listar', { id: value.id, skip: 0, take: 5 }).then(res => {
            setBecas(res.data);
        });
    }, []);
    return (
            ...
            <Grid container>
                ...
                <Grid item xs={12} my={6}>
                    <Negrita sx={{ fontSize: 32, textAlign: 'center' }}>
                        {dayjs(value.termina, 'DD/MM/YYYY').format('DD [de] MMMM [del] YYYY')}
                    </Negrita>
                ...
                <Grid item xs={12}>
                    <Box sx={{ mx: { xs: 0, sm: 10, lg: 25 }, mt: 2 }}>
                        ...
                        <Tabs defaultActiveKey="1"
                            ...
                            <Tabs.Tab eventKey="2" title="Fechas">
                                <Box display='flex' flexDirection='column'
                                    ...
                                    <Titulo sx={{ textAlign: 'center', fontWeight: 500 }}>
                                        ...
                                        {dayjs(value.termina, 'DD/MM/YYYY').format('[Hasta el] DD [de] MMMM YYYY')}
                                    </Titulo>
                            ...
                            <Tabs.Tab eventKey="6" title="Participantes">
                                <Box display='flex' flexDirection='column'
                                    alignItems='center' justifyContent='center'
                                    py={3} px={1}>
                                    ...
                                    <Titulo sx={{
                                        ...
                                        <Icon icon='fluent:people-20-regular' fontSize={40}
                            ...
                            <Tabs.Tab eventKey="7" title="Encargado">
                                <Box display='flex' flexDirection='column'
                                    alignItems='center' justifyContent='center'
                                    py={3} px={1}>
                                    <Titulo sx={{
                ...
                <Grid item xs={12} pb={2}
                    px={{ xs: 3, sm: 10, md: 20, lg: 40, xl: 60 }}>
                ...
                <Grid container>
                    <Grid item xs={6} sm={4}>
                        <Button appearance="primary" block size='lg'
                            ...
                            style={{ background: grey[900], borderRadius: 0 }}>
                            Solicitar Participación
                        </Button>
                    </Grid>
                    <Grid item xs={6} sm={4}>
